...
2. Do you see some fields missing here that cannot set with MDC ?

3. On MDC fields, is it preferable to use the same keys for all applications? Can we provide a java class that contains all MDC keys allowed?
