...
The objectives are as follows:
    ...
    If it's on service request the please use this key name :HEADER_REQUEST_CORRELATION_ID define in MdcKeys.java
...
2. Configure your Layout as described here [Layouts](#layout)	  
