...
public class TestMongoCriteria_In extends TestMongoCriteria_Abstract {
    ...
    @Test
    public void testParseFieldIn_quoted1() throws Exception {
    ...
    @Test
    public void testParseFieldIn_quoted2() throws Exception {
    ...
    @Test
    public void testParseFieldIn_quoted5() throws Exception {
    ...
    @Test
    public void testParseFieldIn_int1() throws Exception {
    ...
    @Test
    public void testParseFieldIn_int2() throws Exception {
    ...
    @Test
    public void testParseFieldIn_int5() throws Exception {
    ...
    @Test
    public void testParseFieldIn_decimal1() throws Exception {
    ...
    @Test
    public void testParseFieldIn_decimal2() throws Exception {
    ...
    @Test
    public void testParseFieldIn_decimal5() throws Exception {
    ...
    @Test
    public void testParseFieldIn_string() throws Exception {
        expectedException.expect(Exception.class);
        Criteria criteria = doTest("field1 in [a, b]");
    }

    @Test
    public void testParseFieldIn_boolean() throws Exception {
    ...
    @Test
    public void testParseFieldIn_mix() throws Exception {
