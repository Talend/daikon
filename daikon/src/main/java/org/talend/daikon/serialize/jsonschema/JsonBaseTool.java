...
public class JsonBaseTool {
    ...
    protected static boolean isListClass(String className) {
        return StringUtils.startsWith(className, "java.util.List");
    }
     ...
     * @return
     */
    protected static boolean isStringListClass(String className) {
        return StringUtils.equals(className, "java.util.List<java.lang.String>");
    }
